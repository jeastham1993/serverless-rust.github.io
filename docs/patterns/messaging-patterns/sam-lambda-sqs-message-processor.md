...
A SQS to Lambda template is found under the [./templates](https://github.com/jeastham1993/serverless-rust.github.io/templates/sqs-lambda) directory in the GitHub repo. You can use template to get started building with SQS and Lambda.
